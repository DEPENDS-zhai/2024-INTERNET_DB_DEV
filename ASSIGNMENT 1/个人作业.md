![23](https://github.com/user-attachments/assets/280c35bf-92c0-4c35-ace2-092ed148c57f)
# 个人作业1：Web前端初探
...
截图如下所示：
    <div align=center>
         <img src="evidImage/2.png" alt="Img_F12" width="300">
    </div>
...
从截图可以看到，登录操作的请求详细信息：
    <div align=center>
         <img src="evidImage/7.png" alt="POST_200" width="300">
    </div>
...
请求头部 包含了客户端向服务器发起请求的详细信息，例如数据类型、压缩方式、来源页面等。
    <div align=center>
         <img src="evidImage/5.png" alt="Req_Header" width="300">
    </div>
...
POST 请求中提交的具体数据：
    <div align=center>
         <img src="evidImage/3.png" alt="Payload" width="300">
    </div>
...
响应头部 提供了服务器对客户端的响应配置，包括缓存控制、编码方式、时间等安全选项。
    <div align=center>
         <img src="evidImage/6.png" alt="Res_Header" width="300">
    </div>
...
通过筛选，我们发现其通过GET方法获取验证码图片，具体截图如下：
    <div align=center>
         <img src="evidImage/8.png" alt="GET_200" width="300">
    </div>
        <div align=center>
         <img src="evidImage/1.png" alt="verify" width="300">
    </div>
...
POST	提交数据到服务器，修改状态。	用于登录、注册，提交表单信息等。
    <div align=center>
         <img src="evidImage/9.png" alt="GET_Req" width="300">
    </div>
在请求头部中：
...
POST	请求体中包含用户名、密码等数据。	返回 JSON 数据或登录状态信息。
    ...
    <div align=center>
         <img src="evidImage/10.png" alt="GET_Res" width="300">
    </div>
...
我们首先找到改图片所对应的id值，通过在页面中检查元素的方法，可以知道该图片的id为`#verifyImg`。
    <div align=center>
         <img src="evidImage/22.png" alt="Before" width="300">
    </div>
我们再通过语句
```html
...
用来刷新网页中验证码资源显示，刷新前后效果如图：
    <div align=center>
         <img src="evidImage/13.png" alt="Before" width="300">
    </div>

        <div align=center>
         <img src="evidImage/14.png" alt="After" width="300">
    </div>
...
该插件在浏览器工具栏上显示一个按钮，点击后弹出页面，提供跳转到指定网站的功能。
    <div align=center>
         <img src="evidImage/23.png" alt="Before" width="300">
    </div>
